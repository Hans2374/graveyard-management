...
function ServiceOrderDetails({ open, onClose }) {
  ...
  const handleQuantityChange = (index, value) => {
    setItems(
      items.map((item, i) =>
        i === index
          ? { ...item, quantity: Math.max(1, Math.min(10, value)) }
          : item
      )
    );
  };
  ...
  return (
    <>
      ...
      >
        <DialogTitle
          align="center"
          sx={{ marginBottom: "20px", backgroundColor:"var(--primary-color)", color:"white"}}
        >
          Thông Tin Chi Tiết Dịch Vụ
        </DialogTitle>
        <DialogContent>
            <Box sx={{ width: "100%", p: "0px 24px", m:"20px 0 0 0 " }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.maDon}</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.sdt}</Typography>
                </Grid>
              </Grid>
            </Grid>
            ...
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.ngayTao}</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.hoTen}</Typography>
                </Grid>
              </Grid>
            </Grid>
            ...
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.thanhToan}</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.diaChi}</Typography>
                </Grid>
              </Grid>
            </Grid>
            ...
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.khachHang}</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.trangThai}</Typography>
                </Grid>
              </Grid>
            </Grid>
            ...
            <Grid item xs={6}>
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item xs={8}>
                  <Typography>{mockData.thoiGian}</Typography>
                </Grid>
              </Grid>
            </Grid>
